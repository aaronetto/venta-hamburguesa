...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nombre) || empty($apellidos) || empty($correo) || empty($telefono)) {
        ...
        $stmt = $conexion->prepare("SELECT ID_CLIENTE FROM cliente WHERE CORREO = ? AND ID_CLIENTE != ?");
        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                $error = "Error al actualizar el cliente: " . $conexion->error;
            }
        }
        $stmt->close();
    }
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="apellidos" name="apellidos" 
                                       value="<?php echo htmlspecialchars($_POST['apellidos'] ?? $cliente['APELLIDOS']); ?>" 
                                       maxlength="45" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="email" id="correo" name="correo" 
                                       value="<?php echo htmlspecialchars($_POST['correo'] ?? $cliente['CORREO']); ?>" 
                                       maxlength="45" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" id="telefono" name="telefono" 
                                       value="<?php echo htmlspecialchars($_POST['telefono'] ?? $cliente['TELEFONO']); ?>" 
                                       maxlength="45" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="direccion" name="direccion" 
                                   value="<?php echo htmlspecialchars($_POST['direccion'] ?? $cliente['DIRECCION']); ?>" 
